...
const CreateInvoiceParamsSchema = createInsertSchema(invoices).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  companyId: true,
});
const UpdateInvoiceParamsSchema = createUpdateSchema(invoices).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  companyId: true,
...
const CreateInvoiceLineParamsSchema = createInsertSchema(invoiceLines).omit({
  createdAt: true,
  updatedAt: true,
  id: true,
  invoiceId: true,
});
const UpdateInvoiceLineParamsSchema = createUpdateSchema(invoiceLines).omit({
  createdAt: true,
  updatedAt: true,
  id: true,
  invoiceId: true,
