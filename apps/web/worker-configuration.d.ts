/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv worker-configuration.d.ts` (hash: 1317a1bb9a800a363c3753e4d1b8d749)
// Runtime types generated with workerd@1.20250617.0 2025-06-30 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_BASE_URL: "http://localhost:3001" | "https://app.fundlevel.co";
		NEXT_PUBLIC_SERVER_URL: "http://localhost:3000" | "https://api.fundlevel.co";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_BASE_URL" | "NEXT_PUBLIC_SERVER_URL">> {}
}
