/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 4e7677860dfa98fa9a0509e7f17ab05d)
// Runtime types generated with workerd@1.20250617.0 2025-06-30 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		BASE_URL: "http://localhost:3002" | "https://app.fundlevel.co";
		SERVER_URL: "http://localhost:3000" | "https://api.fundlevel.co";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "SERVER_URL">> {}
}
