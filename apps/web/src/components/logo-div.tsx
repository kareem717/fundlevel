...
export const LogoDiv: FC<LogoDivProps> = ({ className, href = redirects.app.explore.index, ...props }) => {
  return (
    <Link
...
export const SmallLogoDiv: FC<LogoDivProps> = ({ className, href = redirects.app.explore.index, ...props }) => {
  return (
    <Link
