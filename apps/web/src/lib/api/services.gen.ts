 ...
 * Get round create requirements.
 */
export const getBusinessRoundCreateRequirements = <ThrowOnError extends boolean = false>(options: Options<GetBusinessRoundCreateRequirementsData, ThrowOnError>) => { return (options?.client ?? client).get<GetBusinessRoundCreateRequirementsResponse, GetBusinessRoundCreateRequirementsError, ThrowOnError>({
    ...options,
 ...
 */
export const getBusinessMemberRoles = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetBusinessMemberRolesResponse, GetBusinessMemberRolesError, ThrowOnError>({
    ...options,
 ...
 * Upsert business legal section.
 */
export const upsertBusinessLegalSection = <ThrowOnError extends boolean = false>(options: Options<UpsertBusinessLegalSectionData, ThrowOnError>) => { return (options?.client ?? client).put<UpsertBusinessLegalSectionResponse, UpsertBusinessLegalSectionError, ThrowOnError>({
    ...options,
 ...
 * Get business stripe account.
 */
export const getBusinessStripeAccount = <ThrowOnError extends boolean = false>(options: Options<GetBusinessStripeAccountData, ThrowOnError>) => { return (options?.client ?? client).get<GetBusinessStripeAccountResponse, GetBusinessStripeAccountError, ThrowOnError>({
    ...options,
    url: '/business/{id}/stripe',
    responseTransformer: GetBusinessStripeAccountResponseTransformer
}); };
 ...
 */
export const getInvestmentActivePayment = <ThrowOnError extends boolean = false>(options: Options<GetInvestmentActivePaymentData, ThrowOnError>) => { return (options?.client ?? client).get<GetInvestmentActivePaymentResponse, GetInvestmentActivePaymentError, ThrowOnError>({
    ...options,
    url: '/investments/{id}/pay',
    responseTransformer: GetInvestmentActivePaymentResponseTransformer
}); };
 ...
 */
export const createInvestmentPaymentIntent = <ThrowOnError extends boolean = false>(options: Options<CreateInvestmentPaymentIntentData, ThrowOnError>) => { return (options?.client ?? client).post<CreateInvestmentPaymentIntentResponse, CreateInvestmentPaymentIntentError, ThrowOnError>({
    ...options,
    url: '/investments/{id}/pay'
}); };
 ...
 * Get a round investment payments.
 */
export const getInvestmentPayments = <ThrowOnError extends boolean = false>(options: Options<GetInvestmentPaymentsData, ThrowOnError>) => { return (options?.client ?? client).get<GetInvestmentPaymentsResponse, GetInvestmentPaymentsError, ThrowOnError>({
    ...options,
    url: '/investments/{id}/payments',
    responseTransformer: GetInvestmentPaymentsResponseTransformer
}); };
