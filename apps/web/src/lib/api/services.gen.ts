 ...
 * Get rounds.
 */
export const getRounds = <ThrowOnError extends boolean = false>(options: Options<GetRoundsData, ThrowOnError>) => { return (options?.client ?? client).get<GetRoundsResponse, GetRoundsError, ThrowOnError>({
    ...options,
    url: '/account/{id}/rounds',
    responseTransformer: GetRoundsResponseTransformer
}); };
