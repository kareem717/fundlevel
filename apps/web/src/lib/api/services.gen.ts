...
import { type CreateAccountData, type CreateAccountError, type CreateAccountResponse, type DeleteAccountData, type DeleteAccountError, type DeleteAccountResponse, type GetAccountByIdData, type GetAccountByIdError, type GetAccountByIdResponse, type UpdateAccountData, type UpdateAccountError, type UpdateAccountResponse, type GetAccountBusinessesData, type GetAccountBusinessesError, type GetAccountBusinessesResponse, type GetAccountInvestmentsByCursorData, type GetAccountInvestmentsByCursorError, type GetAccountInvestmentsByCursorResponse, type CreateRoundInvestmentData, type CreateRoundInvestmentError, type CreateRoundInvestmentResponse, type GetAccountInvestmentsByPageData, type GetAccountInvestmentsByPageError, type GetAccountInvestmentsByPageResponse, type DeleteRoundInvestmentData, type DeleteRoundInvestmentError, type DeleteRoundInvestmentResponse, type GetAccountCheckoutLinkData, type GetAccountCheckoutLinkError, type GetAccountCheckoutLinkResponse, type WithdrawInvestmentData, type WithdrawInvestmentError, type WithdrawInvestmentResponse, type HandleStripeWebhookData, type HandleStripeWebhookError, type HandleStripeWebhookResponse, type CreateBusinessData, type CreateBusinessError, type CreateBusinessResponse, type DeleteBusinessData, type DeleteBusinessError, type DeleteBusinessResponse, type GetBusinessByIdData, type GetBusinessByIdError, type GetBusinessByIdResponse, type GetBusinessTotalFundingData, type GetBusinessTotalFundingError, type GetBusinessTotalFundingResponse, type GetBusinessInvestmentsByCursorData, type GetBusinessInvestmentsByCursorError, type GetBusinessInvestmentsByCursorResponse, type GetBusinessInvestmentsByPageData, type GetBusinessInvestmentsByPageError, type GetBusinessInvestmentsByPageResponse, type GetBusinessRoundsByCursorData, type GetBusinessRoundsByCursorError, type GetBusinessRoundsByCursorResponse, type GetBusinessRoundsByPageData, type GetBusinessRoundsByPageError, type GetBusinessRoundsByPageResponse, type GetBusinessVenturesByCursorData, type GetBusinessVenturesByCursorError, type GetBusinessVenturesByCursorResponse, type GetBusinessVenturesByPageData, type GetBusinessVenturesByPageError, type GetBusinessVenturesByPageResponse, type HealthCheckError, type HealthCheckResponse, type GetAllIndustriesError, type GetAllIndustriesResponse, type GetInvestmentByIdData, type GetInvestmentByIdError, type GetInvestmentByIdResponse, type GetRoundByCursorData, type GetRoundByCursorError, type GetRoundByCursorResponse, type CreateRoundData, type CreateRoundError, type CreateRoundResponse, type GetRoundsByPageData, type GetRoundsByPageError, type GetRoundsByPageResponse, type DeleteRoundData, type DeleteRoundError, type DeleteRoundResponse, type GetRoundByIdData, type GetRoundByIdError, type GetRoundByIdResponse, type DeleteRoundLikeData, type DeleteRoundLikeError, type DeleteRoundLikeResponse, type GetRoundLikeStatusData, type GetRoundLikeStatusError, type GetRoundLikeStatusResponse, type CreateRoundLikeData, type CreateRoundLikeError, type CreateRoundLikeResponse, type GetRoundInvestmentsByCursorData, type GetRoundInvestmentsByCursorError, type GetRoundInvestmentsByCursorResponse, type GetRoundInvestmentsByPageData, type GetRoundInvestmentsByPageError, type GetRoundInvestmentsByPageResponse, type AcceptInvestmentData, type AcceptInvestmentError, type AcceptInvestmentResponse, type GetRoundLikeCountData, type GetRoundLikeCountError, type GetRoundLikeCountResponse, type GetUserAccountData, type GetUserAccountError, type GetUserAccountResponse, type GetVenturesByCursorData, type GetVenturesByCursorError, type GetVenturesByCursorResponse, type CreateVentureData, type CreateVentureError, type CreateVentureResponse, type GetVenturesByPageData, type GetVenturesByPageError, type GetVenturesByPageResponse, type DeleteVentureData, type DeleteVentureError, type DeleteVentureResponse, type GetVentureByIdData, type GetVentureByIdError, type GetVentureByIdResponse, type UpdateVentureData, type UpdateVentureError, type UpdateVentureResponse, type DeleteVentureLikeData, type DeleteVentureLikeError, type DeleteVentureLikeResponse, type GetVentureLikeStatusData, type GetVentureLikeStatusError, type GetVentureLikeStatusResponse, type CreateVentureLikeData, type CreateVentureLikeError, type CreateVentureLikeResponse, type GetVentureLikeCountData, type GetVentureLikeCountError, type GetVentureLikeCountResponse, type GetVentureRoundInvestmentsByCursorData, type GetVentureRoundInvestmentsByCursorError, type GetVentureRoundInvestmentsByCursorResponse, type GetVentureRoundInvestmentsByPageData, type GetVentureRoundInvestmentsByPageError, type GetVentureRoundInvestmentsByPageResponse, type GetVentureRoundsByCursorData, type GetVentureRoundsByCursorError, type GetVentureRoundsByCursorResponse, type GetVentureActiveRoundData, type GetVentureActiveRoundError, type GetVentureActiveRoundResponse, type GetVentureRoundsByPageData, type GetVentureRoundsByPageError, type GetVentureRoundsByPageResponse, CreateAccountResponseTransformer, GetAccountByIdResponseTransformer, UpdateAccountResponseTransformer, GetAccountBusinessesResponseTransformer, GetAccountInvestmentsByCursorResponseTransformer, CreateRoundInvestmentResponseTransformer, GetAccountInvestmentsByPageResponseTransformer, CreateBusinessResponseTransformer, GetBusinessByIdResponseTransformer, GetBusinessInvestmentsByCursorResponseTransformer, GetBusinessInvestmentsByPageResponseTransformer, GetBusinessRoundsByCursorResponseTransformer, GetBusinessRoundsByPageResponseTransformer, GetBusinessVenturesByCursorResponseTransformer, GetBusinessVenturesByPageResponseTransformer, GetAllIndustriesResponseTransformer, GetInvestmentByIdResponseTransformer, GetRoundByCursorResponseTransformer, CreateRoundResponseTransformer, GetRoundsByPageResponseTransformer, GetRoundByIdResponseTransformer, GetRoundInvestmentsByCursorResponseTransformer, GetRoundInvestmentsByPageResponseTransformer, GetUserAccountResponseTransformer, GetVenturesByCursorResponseTransformer, CreateVentureResponseTransformer, GetVenturesByPageResponseTransformer, GetVentureByIdResponseTransformer, UpdateVentureResponseTransformer, GetVentureRoundInvestmentsByCursorResponseTransformer, GetVentureRoundInvestmentsByPageResponseTransformer, GetVentureRoundsByCursorResponseTransformer, GetVentureActiveRoundResponseTransformer, GetVentureRoundsByPageResponseTransformer } from './types.gen';
 ...
 * Withdraw a investment.
 */
export const withdrawInvestment = <ThrowOnError extends boolean = false>(options: Options<WithdrawInvestmentData, ThrowOnError>) => { return (options?.client ?? client).post<WithdrawInvestmentResponse, WithdrawInvestmentError, ThrowOnError>({
    ...options,
 ...
 */
export const getBusinessVenturesByCursor = <ThrowOnError extends boolean = false>(options: Options<GetBusinessVenturesByCursorData, ThrowOnError>) => { return (options?.client ?? client).get<GetBusinessVenturesByCursorResponse, GetBusinessVenturesByCursorError, ThrowOnError>({
    ...options,
 ...
 * Delete a round like.
 */
export const deleteRoundLike = <ThrowOnError extends boolean = false>(options: Options<DeleteRoundLikeData, ThrowOnError>) => { return (options?.client ?? client).delete<DeleteRoundLikeResponse, DeleteRoundLikeError, ThrowOnError>({
    ...options,
 ...
 * Get a round like status.
 */
export const getRoundLikeStatus = <ThrowOnError extends boolean = false>(options: Options<GetRoundLikeStatusData, ThrowOnError>) => { return (options?.client ?? client).get<GetRoundLikeStatusResponse, GetRoundLikeStatusError, ThrowOnError>({
    ...options,
    url: '/round/{id}/account/{accountId}/like'
}); };
 ...
 * Create a round like.
 */
export const createRoundLike = <ThrowOnError extends boolean = false>(options: Options<CreateRoundLikeData, ThrowOnError>) => { return (options?.client ?? client).post<CreateRoundLikeResponse, CreateRoundLikeError, ThrowOnError>({
    ...options,
    url: '/round/{id}/account/{accountId}/like'
}); };
 ...
 * Get round investments.
 */
export const getRoundInvestmentsByCursor = <ThrowOnError extends boolean = false>(options: Options<GetRoundInvestmentsByCursorData, ThrowOnError>) => { return (options?.client ?? client).get<GetRoundInvestmentsByCursorResponse, GetRoundInvestmentsByCursorError, ThrowOnError>({
    ...options,
 ...
 * Get round investments.
 */
export const getRoundInvestmentsByPage = <ThrowOnError extends boolean = false>(options: Options<GetRoundInvestmentsByPageData, ThrowOnError>) => { return (options?.client ?? client).get<GetRoundInvestmentsByPageResponse, GetRoundInvestmentsByPageError, ThrowOnError>({
    ...options,
 ...
 * Accept an investment.
 */
export const acceptInvestment = <ThrowOnError extends boolean = false>(options: Options<AcceptInvestmentData, ThrowOnError>) => { return (options?.client ?? client).post<AcceptInvestmentResponse, AcceptInvestmentError, ThrowOnError>({
    ...options,
 ...
 * Get a round like count.
 */
export const getRoundLikeCount = <ThrowOnError extends boolean = false>(options: Options<GetRoundLikeCountData, ThrowOnError>) => { return (options?.client ?? client).get<GetRoundLikeCountResponse, GetRoundLikeCountError, ThrowOnError>({
    ...options,
    url: '/round/{id}/like'
}); };
 ...
 * Get cursor paginated ventures.
 */
export const getVenturesByCursor = <ThrowOnError extends boolean = false>(options?: Options<GetVenturesByCursorData, ThrowOnError>) => { return (options?.client ?? client).get<GetVenturesByCursorResponse, GetVenturesByCursorError, ThrowOnError>({
    ...options,
    url: '/venture',
 ...
 * Get offset paginated ventures.
 */
export const getVenturesByPage = <ThrowOnError extends boolean = false>(options?: Options<GetVenturesByPageData, ThrowOnError>) => { return (options?.client ?? client).get<GetVenturesByPageResponse, GetVenturesByPageError, ThrowOnError>({
    ...options,
    url: '/venture/page',
 ...
 * Delete a venture like.
 */
export const deleteVentureLike = <ThrowOnError extends boolean = false>(options: Options<DeleteVentureLikeData, ThrowOnError>) => { return (options?.client ?? client).delete<DeleteVentureLikeResponse, DeleteVentureLikeError, ThrowOnError>({
    ...options,
 ...
 * Get a venture like status.
 */
export const getVentureLikeStatus = <ThrowOnError extends boolean = false>(options: Options<GetVentureLikeStatusData, ThrowOnError>) => { return (options?.client ?? client).get<GetVentureLikeStatusResponse, GetVentureLikeStatusError, ThrowOnError>({
    ...options,
    url: '/venture/{id}/account/{accountId}/like'
}); };
 ...
 * Create a venture like.
 */
export const createVentureLike = <ThrowOnError extends boolean = false>(options: Options<CreateVentureLikeData, ThrowOnError>) => { return (options?.client ?? client).post<CreateVentureLikeResponse, CreateVentureLikeError, ThrowOnError>({
    ...options,
    url: '/venture/{id}/account/{accountId}/like'
}); };
 ...
 * Get a venture like count.
 */
export const getVentureLikeCount = <ThrowOnError extends boolean = false>(options: Options<GetVentureLikeCountData, ThrowOnError>) => { return (options?.client ?? client).get<GetVentureLikeCountResponse, GetVentureLikeCountError, ThrowOnError>({
    ...options,
    url: '/venture/{id}/like'
}); };
 ...
 */
export const getVentureRoundInvestmentsByCursor = <ThrowOnError extends boolean = false>(options: Options<GetVentureRoundInvestmentsByCursorData, ThrowOnError>) => { return (options?.client ?? client).get<GetVentureRoundInvestmentsByCursorResponse, GetVentureRoundInvestmentsByCursorError, ThrowOnError>({
    ...options,
 ...
 * Get all round investments for a venture.
 */
export const getVentureRoundInvestmentsByPage = <ThrowOnError extends boolean = false>(options: Options<GetVentureRoundInvestmentsByPageData, ThrowOnError>) => { return (options?.client ?? client).get<GetVentureRoundInvestmentsByPageResponse, GetVentureRoundInvestmentsByPageError, ThrowOnError>({
    ...options,
 ...
 */
export const getVentureRoundsByCursor = <ThrowOnError extends boolean = false>(options: Options<GetVentureRoundsByCursorData, ThrowOnError>) => { return (options?.client ?? client).get<GetVentureRoundsByCursorResponse, GetVentureRoundsByCursorError, ThrowOnError>({
    ...options,
 ...
 * Get a venture active round.
 */
export const getVentureActiveRound = <ThrowOnError extends boolean = false>(options: Options<GetVentureActiveRoundData, ThrowOnError>) => { return (options?.client ?? client).get<GetVentureActiveRoundResponse, GetVentureActiveRoundError, ThrowOnError>({
    ...options,
 ...
 * Get all rounds for a venture.
 */
export const getVentureRoundsByPage = <ThrowOnError extends boolean = false>(options: Options<GetVentureRoundsByPageData, ThrowOnError>) => { return (options?.client ?? client).get<GetVentureRoundsByPageResponse, GetVentureRoundsByPageError, ThrowOnError>({
    ...options,
