...
/**
 * Create business legal section
 * Create business legal section.
 */
export const createBusinessLegalSection = <ThrowOnError extends boolean = false>(options: Options<CreateBusinessLegalSectionData, ThrowOnError>) => { return (options?.client ?? client).post<CreateBusinessLegalSectionResponse, CreateBusinessLegalSectionError, ThrowOnError>({
    ...options,
