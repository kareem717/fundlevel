 ...
 * Get businesses.
 */
export const getAccountBusinessesOffset = <ThrowOnError extends boolean = false>(options: Options<GetAccountBusinessesOffsetData, ThrowOnError>) => { return (options?.client ?? client).get<GetAccountBusinessesOffsetResponse, GetAccountBusinessesOffsetError, ThrowOnError>({
    ...options,
    url: '/account/{id}/businesses/offset',
    responseTransformer: GetAccountBusinessesOffsetResponseTransformer
}); };
