 ...
 * Get recieved round investments.
 */
export const getAccountRecievedRoundInvestmentsCursor = <ThrowOnError extends boolean = false>(options: Options<GetAccountRecievedRoundInvestmentsCursorData, ThrowOnError>) => { return (options?.client ?? client).get<GetAccountRecievedRoundInvestmentsCursorResponse, GetAccountRecievedRoundInvestmentsCursorError, ThrowOnError>({
    ...options,
    url: '/account/{id}/round-investments/recieved/cursor',
    responseTransformer: GetAccountRecievedRoundInvestmentsCursorResponseTransformer
}); };
