 ...
 * Get daily aggregated venture analytics.
 */
export const getDailyAggregatedVentureAnalytics = <ThrowOnError extends boolean = false>(options: Options<GetDailyAggregatedVentureAnalyticsData, ThrowOnError>) => { return (options?.client ?? client).get<GetDailyAggregatedVentureAnalyticsResponse, GetDailyAggregatedVentureAnalyticsError, ThrowOnError>({
    ...options,
 ...
 * Delete a venture favourite.
 */
export const deleteVentureFavourite = <ThrowOnError extends boolean = false>(options: Options<DeleteVentureFavouriteData, ThrowOnError>) => { return (options?.client ?? client).delete<DeleteVentureFavouriteResponse, DeleteVentureFavouriteError, ThrowOnError>({
    ...options,
 ...
 * Get a venture favourite status.
 */
export const getVentureFavouriteStatus = <ThrowOnError extends boolean = false>(options: Options<GetVentureFavouriteStatusData, ThrowOnError>) => { return (options?.client ?? client).get<GetVentureFavouriteStatusResponse, GetVentureFavouriteStatusError, ThrowOnError>({
    ...options,
    url: '/analytic/ventures/{id}/account/{accountId}/favourite'
}); };
 ...
 * Create a venture favourite.
 */
export const createVentureFavourite = <ThrowOnError extends boolean = false>(options: Options<CreateVentureFavouriteData, ThrowOnError>) => { return (options?.client ?? client).post<CreateVentureFavouriteResponse, CreateVentureFavouriteError, ThrowOnError>({
    ...options,
    url: '/analytic/ventures/{id}/account/{accountId}/favourite'
}); };
 ...
 * Get a venture favourite count.
 */
export const getVentureFavouriteCount = <ThrowOnError extends boolean = false>(options: Options<GetVentureFavouriteCountData, ThrowOnError>) => { return (options?.client ?? client).get<GetVentureFavouriteCountResponse, GetVentureFavouriteCountError, ThrowOnError>({
    ...options,
 ...
 * Get a stripe payment intent client secret.
 */
export const getInvestmentPaymentIntentClientSecret = <ThrowOnError extends boolean = false>(options: Options<GetInvestmentPaymentIntentClientSecretData, ThrowOnError>) => { return (options?.client ?? client).get<GetInvestmentPaymentIntentClientSecretResponse, GetInvestmentPaymentIntentClientSecretError, ThrowOnError>({
    ...options,
 ...
 * Process an investment.
 */
export const processInvestment = <ThrowOnError extends boolean = false>(options: Options<ProcessInvestmentData, ThrowOnError>) => { return (options?.client ?? client).put<ProcessInvestmentResponse, ProcessInvestmentError, ThrowOnError>({
    ...options,
