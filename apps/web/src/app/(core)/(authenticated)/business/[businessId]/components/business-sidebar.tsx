...
export interface BusinessSidebarProps extends ComponentPropsWithoutRef<typeof Sidebar> {
  businessId: number;
}

//TODO: this doesn't have to be a client component
export function BusinessSidebar({ businessId, ...props }: BusinessSidebarProps) {
