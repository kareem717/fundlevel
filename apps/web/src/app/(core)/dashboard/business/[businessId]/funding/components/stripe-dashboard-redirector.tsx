...
import { BusinessStripeAccount } from "@fundlevel/sdk";
import { useToast } from "@fundlevel/ui/hooks/use-toast";
import { ToastAction } from "@fundlevel/ui/components/toast";
import { Loader2 } from "lucide-react";

interface StripeDashboardRedirectorProps
  extends ComponentPropsWithoutRef<typeof Button> {
  stripeAccount: BusinessStripeAccount;
  businessId: number;
}

export function StripeDashboardRedirector({
  className,
  businessId,
  ...props
}: StripeDashboardRedirectorProps) {
  ...
  return (
    <Button onClick={handleClick} disabled={isLoading} role="link">
