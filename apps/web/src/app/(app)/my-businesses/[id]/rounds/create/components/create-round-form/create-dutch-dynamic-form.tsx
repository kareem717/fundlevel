...
import { createDutchDynamicRoundSchema } from "@/actions/validations/rounds";
...
export const CreateDutchDynamicRoundForm: FC<CreateDutchDynamicRoundFormProps> = ({ className, onSuccess, businessId, ...props }) => {
