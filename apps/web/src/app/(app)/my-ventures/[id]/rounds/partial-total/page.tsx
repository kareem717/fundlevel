...
import { getVenturePartialTotalRoundsCursor } from "@/actions/ventures";
import { Icons } from "@/components/icons";
import { PartialTotalRound, } from "@/lib/api";
...
export default function VenturePartialTotalRoundsPage({ params }: { params: { id: string } }) {
  const [data, setData] = useState<PartialTotalRound[]>([])
  ...
  const { executeAsync, isExecuting } = useAction(getVenturePartialTotalRoundsCursor, {
    onSuccess: ({ data }) => {
      const newData = data?.partialTotalRounds ?? []
