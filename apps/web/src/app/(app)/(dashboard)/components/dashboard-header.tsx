...
export interface DashboardHeaderProps extends ComponentPropsWithoutRef<"header"> {
  account: Account
};

export const DashboardHeader: FC<DashboardHeaderProps> = ({ className, account, ...props }) => {
  return (
