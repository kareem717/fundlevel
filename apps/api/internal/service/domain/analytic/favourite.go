...
func (s *AnalyticService) CreateRoundFavourite(ctx context.Context, roundID int, accountID int) error {
	return s.repositories.Analytic().CreateRoundFavourite(ctx, roundID, accountID)
}
...
func (s *AnalyticService) CreateBusinessFavourite(ctx context.Context, businessID int, accountID int) error {
	return s.repositories.Analytic().CreateBusinessFavourite(ctx, businessID, accountID)
}
