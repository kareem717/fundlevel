...
type Round struct {
	...
	PercentageSelling          float64     `json:"percentageSelling" minimum:"0" maximum:"100" example:"10"`
	ValuationAmountUSDCents    int         `json:"valuationAmountUSDCents" minimum:"1" example:"1000000"`
	...
	InvestmentsRequireApproval bool        `json:"investmentsRequireApproval" default:"false"`
...
// 	SortBy    string `query:"sortBy" enum:"begins_at,ends_at,percentage_selling,percentage_value,value_currency,status,investor_count,buy_in,created_at" required:"false"`
