...
export type CreateLinkedAccount = OmitEntityFields<
  Database["public"]["Tables"]["linked_accounts"]["Insert"]
>;

export const linkedAccountSchema = publicLinkedAccountsRowSchemaSchema
  .openapi("LinkedAccount")
  .required();
export const createLinkedAccounttSchema = publicLinkedAccountsInsertSchemaSchema
  .pick({
    name: true,
