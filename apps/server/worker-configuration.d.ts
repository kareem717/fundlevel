/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 4d61f12e52951b21a26e29d114d69c3d)
// Runtime types generated with workerd@1.20250617.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NODE_ENV: "development" | "production";
		BASE_URL: "http://localhost:3000" | "https://api.fundlevel.co";
		WEB_APP_URL: "http://localhost:3001" | "https://app.fundlevel.co";
		BASE_DOMAIN: "localhost" | "fundlevel.co";
		DOCUMENTS_BUCKET_URL: "https://miscos.fundlevel.co" | "https://obj.fundlevel.co";
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "BASE_URL" | "WEB_APP_URL" | "BASE_DOMAIN" | "DOCUMENTS_BUCKET_URL" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "NANGO_SECRET_KEY" | "SENTRY_DSN" | "MISTRAL_API_KEY" | "WORKOS_API_KEY" | "WORKOS_CLIENT_ID" | "WORKOS_COOKIE_PASSWORD">> {}
}
