/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 43cc53f89d684bac45cbab876f9cbc33)
// Runtime types generated with workerd@1.20250617.0 2025-06-30 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NODE_ENV: "development" | "production";
		SERVER_URL: "https://api.fundlevel.co";
		DATABASE_URL: string;
		DIRECT_URL: string;
		CORS_ORIGIN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "SERVER_URL" | "DATABASE_URL" | "DIRECT_URL" | "CORS_ORIGIN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
