...
export const BackgroundBeams: FC<ComponentPropsWithoutRef<"div">> = memo(
  ({ className, ...props }) => {
    ...
    const stopColor = theme.theme === "dark" ? "#FFFFFF" : "#000000";
    return (
      <div
        className={cn(
        ...
        >
          ...
          <defs>
            {paths.map((path, index) => (
              ...
              >
                <stop stopColor={stopColor} stopOpacity="0"></stop>
            ...
            >
              <stop offset="0.0666667" stopColor={stopColor}></stop>
              <stop offset="0.243243" stopColor={stopColor}></stop>
              <stop
                offset="0.43594"
                stopColor={stopColor}
                stopOpacity="0"
