  ...
  return (
    ...
    >
      <div className="flex flex-row items-center justify-between w-full p-6 h-[7vh]">
        ...
        />
        <div className="flex-row items-center justify-end gap-4 hidden md:flex">
          <ModeToggle />
      ...
      {isOpen && (
        <div className="flex flex-col md:hidden border-t transition-all duration-300 ease-in-out">
