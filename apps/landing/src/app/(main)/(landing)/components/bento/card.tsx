...
export const Skeleton: FC<ComponentPropsWithoutRef<"div">> = ({
  ...
  return (
    <div
      className={cn(
        "p-8 overflow-hidden h-full relative flex items-center justify-center",
        className
      )}
      {...props}
    >
...
export const Sparkles: FC<ComponentPropsWithoutRef<"div">> = ({
  className,
  ...props
}) => {
...
export const CardTitle: FC<ComponentPropsWithoutRef<"h3">> = ({
  children,
  className,
}) => {
  return (
...
export const CardDescription: FC<ComponentPropsWithoutRef<"p">> = ({
  children,
  className,
}) => {
  return (
...
export interface CardSkeletonContainerProps extends ComponentPropsWithoutRef<"div"> {
  showGradient?: boolean;
}

export const CardSkeletonContainer: FC<CardSkeletonContainerProps> = ({
  className,
  children,
  showGradient = true,
}) => {
