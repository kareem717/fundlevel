...
CREATE TABLE "bank_accounts" (
	...
	CONSTRAINT "bank_accounts_remote_id_unique" UNIQUE("remote_id"),
...
CREATE TABLE "bank_account_transaction_relationships" (
	"bank_account_transaction_id" integer NOT NULL,
	"entity_id" integer NOT NULL,
	"entity_type" "bank_account_transaction_relationship_entity_type" NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone,
	CONSTRAINT "bank_account_transaction_relationships_bank_account_transaction_id_entity_id_entity_type_pk" PRIMARY KEY("bank_account_transaction_id","entity_id","entity_type")
);
--> statement-breakpoint
CREATE TABLE "bank_account_transactions" (
	...
	"remote_id" text NOT NULL,
	"company_id" integer NOT NULL,
	"bank_account_remote_id" text NOT NULL,
	"iso_currency_code" varchar(3),
	"unofficial_currency_code" varchar(3),
	"check_number" text,
	"date" date NOT NULL,
...
ALTER TABLE "bank_account_transaction_relationships" ADD CONSTRAINT "bat_rels_bt_id_fkey" FOREIGN KEY ("bank_account_transaction_id") REFERENCES "public"."bank_account_transactions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "bank_account_transactions" ADD CONSTRAINT "bank_account_transactions_bank_account_remote_id_bank_accounts_remote_id_fk" FOREIGN KEY ("bank_account_remote_id") REFERENCES "public"."bank_accounts"("remote_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "bank_account_transactions" ADD CONSTRAINT "bank_account_transactions_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
